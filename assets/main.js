...
function carregar () {
	var msg = window.document.getElementById('text01')
	var img = window.document.getElementById('imagem')
	var cpm = window.document.getElementById('text03')
	...
	msg.innerHTML = 'Agora são ' + hora + ':' + min + ' hs.' 
		if (hora >= 0 && hora < 12) {
			//bom dia!
			img.src = 'assets/images/dia.jpg'
			cpm.innerHTML = 'Bom dia!' 
			document.body.style.backgroundColor = '#c98b38'
			document.body.style.backgroundImage = 'url("assets/images/bg-dia.jpg")'
		
		} else if (hora >= 12 && hora < 18) {
			// Boa tarde! 
			img.src = 'assets/images/tarde.jpg'
			cpm.innerHTML = 'Bom Tarde!'
			document.body.style.backgroundColor = '#4f131e'
			document.body.style.backgroundImage = 'url("assets/images/bg-tarde.jpg")'
		} else {
			//Boa Noite
			img.src = 'assets/images/noite.jpg'
			cpm.innerHTML = 'Boa Noite!'
			document.body.style.backgroundColor = '#222c2b'
...
function envia () {
	...
	location.href = 'https://api.whatsapp.com/send?phone=5511949726856&text=Oi ' + cpmw + '%20Agora%20s%C3%A3o%20exatamente%20'+ hora + ':' + min + '%20hs.','_blank'
